...
// ✅ Use PUBLIC_URL for GitHub Pages navigation
const basePath = process.env.PUBLIC_URL || "";

// First row cards
const cards = [
  { title: "About Me", description: "Get to know me", link: `${basePath}/about`, image: profilePic },
  { title: "Projects", description: "My latest work", link: `${basePath}/projects`, image: projectsPic },
  { title: "Skills", description: "Technologies I use", link: `${basePath}/skills`, image: skillsPic },
];
...
const Home = () => {
  ...
  // helper function to handle GitHub Pages routing correctly
  const handleCardClick = (path) => {
    const relativePath = path.replace(basePath, ""); // ensure clean relative path
